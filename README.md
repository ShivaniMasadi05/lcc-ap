# Local Command Center Frontend - Frappe Authentication
...
```env
FRAPPE_URL=https://dev2.crimescan.ai/
NEXT_PUBLIC_APP_URL=http://localhost:3000
```

## Backend Configuration

The app connects to `https://dev2.crimescan.ai/` for authentication. Make sure the Frappe backend is properly configured for CORS and cookie handling.
